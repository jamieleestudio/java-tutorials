...
class ArchitectureRulesTest {
    ...
    @BeforeAll
    static void setUp() {
        classes = new ClassFileImporter().importPackages("com.example.ms");
    }
    ...
    void rpc_clients_live_in_order_infrastructure_only() {
        ...
        noClasses()
                ...
                .should().dependOnClassesThat().resideInAPackage("..order.infrastructure.feign..")
                .check(classes);
    }
    ...
    // --- Layer direction (compensate for Maven module merge: domain/application/bootstrap → single module) ---

    @Test
    void domain_does_not_depend_on_application() {
        noClasses()
                .that().resideInAnyPackage("..order.domain..", "..product.domain..", "..payment.domain..")
    ...
    void application_does_not_depend_on_infrastructure() {
        noClasses()
                .that().resideInAnyPackage("..order.application..", "..product.application..", "..payment.application..")
                .should().dependOnClassesThat().resideInAnyPackage("..infrastructure..")
                .check(classes);
    }

    @Test
    void domain_does_not_depend_on_infrastructure_or_interfaces() {
        noClasses()
                .that().resideInAnyPackage("..order.domain..", "..product.domain..", "..payment.domain..")
