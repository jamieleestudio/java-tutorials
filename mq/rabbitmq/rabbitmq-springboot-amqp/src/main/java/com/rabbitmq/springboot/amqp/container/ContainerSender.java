package com.rabbitmq.springboot.amqp.container;
...
public class ContainerSender {
    public static void main(String[] args) throws Exception {
        ConnectionFactory connectionFactory = new CachingConnectionFactory(new URI("amqp://guest:guest@192.168.24.180:5670"));
