 ...
 */
package com.yineng.bpe.rocketmq.api.example.simple;

import com.yineng.bpe.rocketmq.api.util.RocketmqUtils;
...
public class AclClient {
    ...
    public static void producer() throws MQClientException {
        ...
        producer.setNamesrvAddr(RocketmqUtils.getNamesrvAddr());
        producer.start();
    ...
    public static void pushConsumer() throws MQClientException {
        ...
        consumer.setNamesrvAddr(RocketmqUtils.getNamesrvAddr());
        //订阅
