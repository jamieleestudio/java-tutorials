 ...
 * 1、git下载压缩包，比如 https://github.com/protocolbuffers/protobuf/releases/download/v3.12.4/protoc-3.12.4-win64.zip
 * 2、解压protoc-3.12.4-win64.zip到一个全英文的目录，比如E:\dev，Path环境变量中添加 E:\dev\protoc-3.12.4-win64\bin
 * 3、编写 User.proto，放在E:\dev\protoc-3.12.4-win64\
 内容：
 syntax = "proto2";

 package kafka;
 option java_package = "com.qingshan.serializer";
 ...
 * 4、bin目录下执行命令 protoc-3.12.4-win64>protoc User.proto --java_out=./
 */
