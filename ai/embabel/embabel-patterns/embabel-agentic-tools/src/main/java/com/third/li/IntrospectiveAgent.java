 ...
 *
 * <p>框架内置两组开箱即用的自省工具（都返回"渐进式工具"门面，模型按需展开）：
 * <ul>
 *   <li>{@link BlackboardTools} —— 查看/检索当前**黑板**（共享上下文）里的对象，
 *       适合"我手上已经有哪些信息"这类问题</li>
 *   <li>{@link AgentProcessTools} —— 查看当前**进程**的状态、历史动作与耗时，
 *       适合"我做到哪一步了 / 花了多久"这类问题</li>
 * </ul>
 *
